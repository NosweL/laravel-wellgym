...
<section class="logos-section theme-bg-primary py-5">
    <div class="container" style="border-radius: 20px;">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <h3 class="text-center">Riwayat Jadwal Aktif</h3>
                ...
                <div class="text-center">
                    <a class="btn btn-primary" href="/jadwal/detail">Kembali</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\welygym\resources\views/jadwal/riwayat.blade.php ENDPATH**/ ?>