                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(url('transaksi/edit', $transaksi->id)); ?>" class="btn btn-sm btn-primary">Edit</a>
                                                <a href="<?php echo e(url('transaksi/delete', $transaksi->id)); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus transaksi ini?')">Hapus</a>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\welygym\resources\views/transaksi/index.blade.php ENDPATH**/ ?>