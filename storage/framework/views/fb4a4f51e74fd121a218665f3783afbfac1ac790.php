                        ...
                        <form action="<?php echo e(route('penilaian.store')); ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="coach_id" id="coach_id" class="form-control">
                                    ...
                                    <option value="<?php echo e($coach->id); ?>"><?php echo e($coach->nama); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="latihan_id" id="latihan_id" class="form-control">
                                    ...
                                    <option value="<?php echo e($latihan->id); ?>"><?php echo e($latihan->nama); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\welygym\resources\views/penilaian/create.blade.php ENDPATH**/ ?>